...
namespace Bug_Tracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Index(string id)
        {
            ...
            else if (viewModel.UserRole == "Project Manager")
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase avatar)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    RoleHelper.ChangeUserRoleTo(user.Id, "New User");
                    ...
                    return RedirectToAction("New User", "Account");
                }
                AddErrors(result);
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var message = new MailMessage
                {
                    ...
                    From = new MailAddress("trevorpopham@gmail.com"),
                    IsBodyHtml = true
            };
